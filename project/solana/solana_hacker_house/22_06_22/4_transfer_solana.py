...
final3 = client.get_confirmed_transaction(resultOfTxhash)
print(f"10.1 final3 결과 ->>>>>>>>>>>>>>>>>>> : ",final3)
print(f"----------------------------------------------------------------------------------------------------------")

final = client.confirm_transaction(resultOfTxhash)

print(f"10. final 결과 ->>>>>>>>>>>>>>>>>>> : ",final)

last = final['result']['value'][0]['confirmationStatus']
print("last ->>>>>>>>>>>>>>>>>", last)

final2 = client.get_confirmed_transaction(resultOfTxhash)
print(f"11. final2 결과 ->>>>>>>>>>>>>>>>>>> : ",final2)


# print("블록에 기록중...........................................................")
# getBalance = client.get_balance("4NwS4ezQ3tU4sX26KUmwzKxQwpgwBFMuGYp6U5TBPvc3")
